...
interface TopNavProps {
  ...
  /** Minimal mode: only shows the version switcher, no breadcrumbs or title */
  minimal?: boolean;
}

export function TopNav({ breadcrumbs, title, actions, minimal }: TopNavProps) {
  if (minimal) {
    return (
      <div className="bg-white border-b border-nz-border px-8 py-2.5">
