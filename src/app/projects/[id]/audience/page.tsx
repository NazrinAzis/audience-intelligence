    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={onClose}>
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-5 py-3 border-t border-[#E5E7EB] text-[10px] text-[#6B7280]">
          Similarity calculated from genre, mechanics, theme overlap, and behavioral profile match via Newzoo GPME data.
        </div>
      </div>
    </div>
  );
...
function ExportDropdown({
  ...
  function handleCopy() {
    ...
    lines.push("Powered by Newzoo Audience Intelligence");
...
function formatFallbackBrief(
  ...
  lines.push("", `Generated by Newzoo Audience Intelligence | ${today}`);
  return lines.join("\n");
}
            ...
            <div className="text-right">
              <div className="text-xs font-medium uppercase tracking-wider text-white/70 mb-1 flex items-center justify-end gap-1">
                <MetricTooltip
                  ...
                  definition="Total players in Newzoo's GPME panel for the selected markets."
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="text-nz-text-secondary">
                        <MetricTooltip
                          ...
                          definition="Players in Newzoo's tracked population who behaviorally match this segment's rules."
                            ...
                            <div className="flex justify-between text-sm">
                              <span className="text-nz-text-secondary">
                                <MetricTooltip
                                  ...
                                  definition="The median conversion rate achieved by segments with a similar behavioral profile across comparable launched titles in Newzoo's GPME catalog."
                            ...
                            <div className="flex justify-between text-sm">
                              <span className="text-nz-text-secondary">
                                <MetricTooltip
                                  ...
                                  definition="Estimated players likely to buy or download your title at launch, based on how similar segments performed for comparable titles in Newzoo's GPME catalog."
                        ...
                        <div className="flex justify-between text-sm">
                          <span className="text-nz-text-secondary">
                            <MetricTooltip
                              ...
                              definition="Real players from this segment who have played your title since launch, from Newzoo's GPME play-history data."
